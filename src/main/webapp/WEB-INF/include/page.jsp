...
<div class="page">
	...
	前往第 <input type="text" id="pageidInput" onkeydown="if(event.keyCode == 13){inputpage();return false;}" size="3" /> 页&nbsp; <input type="button" value="go" class="go" onclick="inputpage();return false;"/>
</div>