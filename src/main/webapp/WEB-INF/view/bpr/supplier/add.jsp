...
<!-- /bpr/supplier/add.jsp -->
<body>
	<form id="addForm" name="addForm" method="post" action="${contextPath }/bpr/supplier/addSave">
		<table class="add_update_table">
			...
			<tr>
				<th>固定电话：</th>
				<td><input type="text" id="addCfixedtelephone" name="cfixedtelephone" class="l-text"/></td>
				<th>联系人：</th>
				<td><input type="text" id="addClinkman" name="clinkman" class="l-text"/></td>
			</tr>
			<tr>
				<th>联系电话：</th>
				<td><input type="text" id="addCcontactnumber" name="ccontactnumber" class="l-text validate[custom[phone]]"/></td>
				<th>Email：</th>
				<td><input type="text" id="addCemail" name="cemail" class="l-text validate[custom[email]]"/></td>
			</tr>
			<tr>
				<th>QQ：</th>
				<td><input type="text" id="addCqq" name="cqq" class="l-text validate[custom[integer]]"/></td>
				<th>微信：</th>
				<td><input type="text" id="addCwechat" name="cwechat" class="l-text"/></td>
			</tr>
			<tr>
				<th>开户行：</th>
				<td><input type="text" id="addCopenbank" name="copenbank" class="l-text"/></td>
				<th>银行卡号：</th>
				<td><input type="text" id="addCbankcardnumber" name="cbankcardnumber" class="l-text validate[custom[integer]]"/></td>
			</tr>
			<tr>
				<th><span style="color: red;">*</span>账期(天数)：</th>
				<td colspan="3"><input type="text" id="addIpaymentdays" name="ipaymentdays" class="l-text validate[required,custom[integer]]" value="0"/></td>
			</tr>
			<tr>
				<th>地址：</th>
	...
	<script type="text/javascript" src="${contextPath}/common/js/bpr/supplier/add.js"></script>
</body>
</html>