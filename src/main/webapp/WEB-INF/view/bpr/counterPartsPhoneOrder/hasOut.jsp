...
<!-- /bpr/counterPartsPhoneOrder/hasOut.jsp -->
<body>
	<form id="searchTable">
	...
	<div id="hasOutToolBar"></div>
	<div id="hasOutMainGrid"></div>
	<!-- javascript文件引用 -->
	...
	<script type="text/javascript" src="${contextPath}/common/js/bpr/counterPartsPhoneOrder/hasOut.js"></script>
</body>
</html>