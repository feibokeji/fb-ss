...
<!-- /bpr/unit/modify.jsp -->
<body>
	<form id="modifyForm" name="modifyForm" method="post" action="${contextPath }/bpr/unit/modifySave">
		<input type="hidden" name="uid" value="${unit.uid }"/>
		<table class="add_update_table">
			<tr>
				<th><span style="color: red;">*</span>单位名称：</th>
				<td><input type="text" id="modifyCname" name="cname" class="l-text validate[required,funcCall[ajaxCname]]" value="${unit.cname }"/></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
  	...
  	<!-- javascript文件引用 -->
	<script type="text/javascript">var contextPath = '${contextPath}';var oldCname = '${unit.cname}';</script>
	...
	<script type="text/javascript" src="${contextPath}/common/js/bpr/unit/modify.js"></script>
</body>
</html>