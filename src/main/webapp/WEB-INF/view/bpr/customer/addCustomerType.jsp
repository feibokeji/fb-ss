...
<!-- /bpr/customer/addCustomerType.jsp -->
<body>
	<form id="addForm" name="addForm" method="post" action="${contextPath }/bpr/customer/addCustomerTypeSave">
	...
	<script type="text/javascript" src="${contextPath}/common/js/bpr/customer/addCustomerType.js"></script>
</body>
</html>