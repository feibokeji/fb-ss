...
<body>
	<form id="modifyForm" name="modifyForm" method="post" action="${contextPath }/bpr/brand/modifySave">
		...
		<table class="add_update_table">
			...
			<tr>
				<th>官方网站：</th>
				<td><input type="text" id="modifyCurl" name="curl" class="l-text" value="${brand.curl }"/></td>
			</tr>
			<tr>
				<th>描述：</th>
				<td colspan="3"><textarea rows="2" cols="72" id="modifyCdesc" name="cdesc" class="l-textarea">${brand.cdesc }</textarea></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
