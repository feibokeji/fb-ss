...
$(function(){
	...
	supplierTable = window['maingrid'] = $("#maingrid").ligerGrid({
        ...
        columns: [
            ...
            { display: '固定电话', name: 'cfixedtelephone', width: 100,minWidth: 80 },
            { display: '联系人', name: 'clinkman', width: 100,minWidth: 80 },
            { display: '联系电话', name: 'ccontactnumber', width: 100,minWidth: 80 },
            { display: 'Email', name: 'cemail', width: 100,minWidth: 80 },
            { display: 'QQ', name: 'cqq', width: 100,minWidth: 80 },
            { display: '微信', name: 'cwechat', width: 100,minWidth: 80 },
            { display: '开户行', name: 'copenbank', width: 100,minWidth: 80 },
            { display: '银行卡号', name: 'cbankcardnumber', width: 100,minWidth: 80 },
            { display: '账期(天数)', name: 'ipaymentdays', width: 80,minWidth: 60 },
            { display: '记录日期', name: 'drecorddateStr', width: 100,minWidth: 80 },
            { display: '更新日期', name: 'dupdatedateStr', width: 100,minWidth: 80 }
            ],
        toolbar: { items: [
