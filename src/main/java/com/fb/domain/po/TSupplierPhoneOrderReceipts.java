...
/**
 * @author 作者：Liu bo
 * @version 创建时间：2019年2月15日 下午5:44:18
 * 供应商手机单据实收实付表
 */
@TableMapper("t_supplier_phone_order_receipts")
public class TSupplierPhoneOrderReceipts extends BaseDomain {

    /**
     * 
     */
    private static final long serialVersionUID = 5117382033530814300L;
