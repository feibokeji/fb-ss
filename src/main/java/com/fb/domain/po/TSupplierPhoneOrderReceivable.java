...
/**
 * @author 作者：Liu bo
 * @version 创建时间：2019年2月15日 下午5:24:23
 * 供应商手机单据应收应付表
 */
@TableMapper("t_supplier_phone_order_receivable")
public class TSupplierPhoneOrderReceivable extends BaseDomain {

    /**
     * 
     */
    private static final long serialVersionUID = 5279163924810897630L;
     ...
     * {@value 应收}      
     * {@value 应付}
     * @param ctypeStr 类型      {@value 应收}      {@value 应付}
     */
     ...
     * {@value 未结算}      
     * {@value 已结算}
     * @param istatusStr 状态      {@value 未结算}      {@value 已结算}
     */
