...
/**
 * @author 作者：Liu bo
 * @version 创建时间：2019年2月15日 下午7:05:03
 * 客户手机单据应收应付表
 */
@TableMapper("t_customer_phone_order_receivable")
public class TCustomerPhoneOrderReceivable extends BaseDomain {

    /**
     * 
     */
    private static final long serialVersionUID = 5082974521539717958L;
    ...
    /**
     * 获取 客户手机单据表外键
     * @return ucustomerphoneorderid
     */
    public String getUcustomerphoneorderid() {
        return ucustomerphoneorderid;
    }
    ...
    /**
     * 设置 客户手机单据表外键
     * @param ucustomerphoneorderid 客户手机单据表外键
     */
    public void setUcustomerphoneorderid(String ucustomerphoneorderid) {
        this.ucustomerphoneorderid = ucustomerphoneorderid;
    }
