...
/**
 * @author 作者：Liu bo
 * @version 创建时间：2019年2月20日 下午5:34:36
 * 同行手机调拨产生的实收实付表
 */
@TableMapper("t_counterparts_phone_receipts")
public class TCounterPartsPhoneReceipts extends BaseDomain {

    /**
     * 
     */
    private static final long serialVersionUID = 9100942355675058316L;
