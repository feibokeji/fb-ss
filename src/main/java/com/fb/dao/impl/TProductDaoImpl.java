...
public class TProductDaoImpl extends SimpMapper<TProduct> implements TProductDao {
    ...
    public List<TProduct> getProductList() {
        String sql = "select t.uid,t.ucategoryid,(select c.cname from t_category c where c.uid = t.ucategoryid) as ccategoryname,t.cno,t.cname,t.nprice from t_product t order by t.cno";
